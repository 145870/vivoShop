...
<link rel="stylesheet" href="/vivoShop/front/css/jiesuan.css" />
<script type="text/javascript"
	src="/vivoShop/front/js/jquery-3.5.1.min.js"></script>
	...
	<div id="box">
		...
		<div id="body">
			...
			<div id="sub_box">
				<div id="sub">
					<div id="sub_img">
						<img src="../image/支付成功.png" />
					</div>
					<div id="sub_wen">
						<p>
							订单提交成功，请尽快完成付款!订单金额:<span>￥9999.00</span>
						</p>
						<p>
							请您在提交订单后<span>29分钟</span>内完成支付，否则订单会自动取消
						</p>
					</div>
				...
				<div id="wen">
					<div>
						<p>订单详情:</p>
						<span style="display: none;">支付单号:20240423956470719466496</span> <span
							style="display: none;">商品名称:vivo X Fold3 Pro 16GB+512GB</span> <span
							style="display: none;">交易金额:9999.00</span> <span
							style="display: none;">交易时间:2024.04.26 10:22</span>
					</div>
				</div>

			</div>
			<div id="zhifu">
				<button id="sub_btn">立即支付</button>
			</div>
		</div>
				...
				<div id="yy">
					...
					<div>
						<img src="/vivoShop/front/image/微博.png" class="c" /> <img
							...
							src="/vivoShop/front/image/链接.png" class="c" /> <img
							src="/vivoShop/front/image/信息圆.png" class="c" />
					</div>
				</div>
			</div>
			<div id="ban">
