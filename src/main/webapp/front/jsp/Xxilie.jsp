...
<link rel="stylesheet" href="../css/Xcss2.css" />
			...
			<div id="body">
				<div id="tu-box">
						<c:forEach items="${urllist }" var="u">
							<div id="tuu" style="background-image: url('${u.url }');">
					...
					<div id="yy">
						...
						<div>
							<img src="../image/微博.png" class="c" /> <img
								...
								src="../image/支付宝支付.png" class="c" /> <img
								src="../image/链接.png" class="c" /> <img src="../image/信息圆.png"
								class="c" />
						</div>
					</div>
				</div>
